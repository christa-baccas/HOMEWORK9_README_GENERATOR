...
const questions = [
      ...
      },
      {
        ...
        name: 'license',
        choice: ['MIT', 'GNU General Public license v3.0', 'Apache License 2.0', 'Boost Software Lisense 1.0']
      },
      {
        type: 'input',
      ...
      {
        type: 'input',
        message: 'Please list any test cases writted for this assignement/project.',
        name: 'question',
      },
